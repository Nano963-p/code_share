-- Initial schema: empty databases only. Never edit after deployment.
/* =========================================================
...
/* =========================================================
   TABLE: user_activity (journal d’activité utilisateur)
   - used for follow/unfollow events displayed in profile "Recent Activities"
   ========================================================= */
